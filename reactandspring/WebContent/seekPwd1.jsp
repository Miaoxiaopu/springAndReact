				...
				<table width="774" height="474" border="0" cellpadding="0" cellspacing="0" align="center">
					...
					<tr>
						<td height="257" align="center" valign="top">
							...
							<form action="seekPwd2.jsp" method="post" onsubmit="">
								...
								<table width="57%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
									<tr align="center">
										...
										<td width="78%" align="left">
											<input type="hidden" name="ID" id="seekPwd2" />
											<input type="text" id="question" size="40" name="seekPwd2" readonly="true" /> <span class="word_orange1"> （只读）</span> </td>
									</tr>
									<tr align="center">
									...
									<tr>
										...
										<td><input type="button" class="btn_grey" value="上一步" onclick="window.location.href='seekPwd.html'"/> &nbsp;
											<input type="button" class="btn_grey" value="下一步" onclick="window.location.href='seekPwd2.html'"/> &nbsp;
											<input type="button" class="btn_grey" value="取消" onclick="window.location.href='stuLogin.html'"/> &nbsp;
